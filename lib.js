...
ig.module('plugins.box2d.lib').defines(function(){
	...
	/////////////////////////////////////
	//     BEGIN IMPORTED box2d.js     //
	// HBehrens/box2d.js @ a1355bfbb8b //
	/////////////////////////////////////
...
b2World.prototype.m_inv_dt0 = null;if(typeof exports !== "undefined") {
  ...
  exports.b2Sweep = b2Sweep
	...
	/////////////////////////////////////
	//      END IMPORTED box2d.js      //
	/////////////////////////////////////
	
	// Fix bug with maxFraction
	b2RayCastInput.prototype.maxFraction = 1

	// namespace all the b2 functions
	for(var key in exports){
		if(exports.hasOwnProperty){
			b2[key.substr(2)] = exports[key]
		}
	}
